...
def get_format(title, text):
    ...
    tfidf = joblib.load("modeles/tfidf.joblib")
...
def predict_lstm(title, text):
    ...
    lstm_model = load_model('modeles/lstm_model.h5')
...
def predict_rf(title, text):
    ...
    # Chargement des modèles
    rf_model = joblib.load('modeles/random_forest_model.joblib')
...
def predict_svm(title, text):
    ...
    # Chargement des modèles
    svm_model = joblib.load('modeles/svm_model.joblib')
